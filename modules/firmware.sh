...
#
function on_print() {
    echo "This script installs a variety of Mindstorms firmware to the system so it is accessible for all users. Both official Lego firmware and unofficial 3rd-party binaries are included."
    echo "See the README in the install directory for details."
    echo ""
}
